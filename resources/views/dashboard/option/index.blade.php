<x-layout :title="'الخصائص'" :breadcrumbs="['dashboard.customers.index']">
    @include('dashboard.accounts.customers.partials.filter')

    @component('dashboard::components.table-box')

        @slot('title')
            @lang('customers.actions.list') ({{ count_formatted($CustomFields->total()) }})
        @endslot
            ...
            <th colspan="100">
                <div class="d-flex">
                    ...
                    <div class="ml-2 d-flex justify-content-between flex-grow-1">
                        ...
                        @include('dashboard.CustomFields.partials.actions.trashed')
                    </div>
                </div>
            </th>
        </tr>
