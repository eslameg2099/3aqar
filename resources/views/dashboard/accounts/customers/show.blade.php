<x-layout :title="$customer->name" :breadcrumbs="['dashboard.customers.show', $customer]">
    @component('dashboard::components.box')
        ...
        <table class="table table-striped table-middle">
            ...
            <tr>
                <th width="200">@lang('customers.attributes.RequsetDischarges')</th>
                <td>
                    @if($customer->getFirstMedia('RequsetDischarges'))
                        <file-preview :media="{{ $customer->getMediaResource('RequsetDischarges') }}"></file-preview>
