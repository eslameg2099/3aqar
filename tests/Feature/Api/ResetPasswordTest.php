...
{
    /** @test */
    public function itCanSendPasswordResetVerificationCodeToUser()
    {
        Notification::fake();
    ...
    public function testVerificationTokenCanBeRetrieved()
    {
    ...
    public function testPasswordCanBeUpdatedByResetToken()
    {
        Notification::fake();
