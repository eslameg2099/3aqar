...
return [
    ...
    'lang' => [
        ...
        'types' => resource_path('lang/{lang}/types.php'),
        'estates' => resource_path('lang/{lang}/estates.php'),
        'contractors' => resource_path('lang/{lang}/contractors.php'),
        'orders' => resource_path('lang/{lang}/orders.php'),
        'engineering_offices' => resource_path('lang/{lang}/engineering_offices.php'),
