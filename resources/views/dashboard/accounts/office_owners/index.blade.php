<x-layout :title="trans('office_owners.plural')" :breadcrumbs="['dashboard.office_owners.index']">
        ...
        @forelse($officeOwners as $officeOwner)
            <tr>
                ...
                <td style="width: 160px">
                    ...
                    @if($officeOwner->phone_verified_at != null )
                    @include('dashboard.accounts.office_owners.disactive')
                    @elseif($officeOwner->phone_verified_at == null )
                    @include('dashboard.accounts.office_owners.active')
                    @endif
