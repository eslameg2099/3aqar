        ...
        @forelse($customers as $customer)
            <tr>
                ...
                <td style="width: 160px">
                    ...
                    @include('dashboard.accounts.customers.partials.actions.disactive')
                    @elseif($customer->phone_verified_at == null )
                    @include('dashboard.accounts.customers.partials.actions.active')
                    @endif
